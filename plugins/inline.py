...
async def answer(bot, query):
    ...
    if results:
        ...
        switch_pm_text = f'{emoji.CROSS_MARK} No Media Found in Nurse Media Search Bot🙁'
        if string:
            switch_pm_text += f' for "{string}"'
...
def get_reply_markup(username, query):
    ...
    buttons = [
        ...
        [
           ...
           InlineKeyboardButton('Rate us ★', url='https://t.me/tlgrmcbot?start=Nurseinlinesearchbot-review'),
        ],
    ]
